...
export const SEED_ROLES: Role[] = [
  ...
  },
  {
    id: "r-dept-manager",
    name: "مدير إدارة",
    description: "إدارة أهداف الإدارة، اعتماد نتائج الفرق، ومتابعة الإنجاز على مستوى الإدارة.",
    isSystem: true,
    permissions: [
      "organization.view",
      "users.view",
  ...
  },
  {
    id: "r-team-lead",
    name: "قائد فريق",
    description: "قيادة فريق في تحقيق الأهداف المعتمدة وإسناد المهام ومراجعة التحديثات.",
    isSystem: true,
    permissions: [
      "organization.view",
      "users.view",
  ...
  },
  {
    id: "r-employee",
    name: "موظف",
    description: "تحديث إنجاز النتائج الرئيسية المسندة وإرفاق الأدلة ومتابعة التقدم.",
    isSystem: true,
    permissions: [
      "goals.view",
      "keyresults.update",
